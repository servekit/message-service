// Package gid_service adapts gid-service to message-service's internal needs.
//
...
// clean NextID shape that message-service's business code consumes. Building the
